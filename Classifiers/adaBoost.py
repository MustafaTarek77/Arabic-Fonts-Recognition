...
def adaBoostTrain(data_set, Y):
    ...
    pickle.dump(clf, open('./Classifiers/AdaBoost_model.pkl', 'wb'))
    model = pickle.load(open('./Classifiers/AdaBoost_model.pkl', 'rb'))
